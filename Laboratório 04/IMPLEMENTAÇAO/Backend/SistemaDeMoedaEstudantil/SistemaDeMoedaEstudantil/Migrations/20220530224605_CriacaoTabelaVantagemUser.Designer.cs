...
namespace SistemaDeMoedaEstudantil.Migrations
{
    ...
    [Migration("20220530224605_CriacaoTabelaVantagemUser")]
    partial class CriacaoTabelaVantagemUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaDeMoedaEstudantil.Model.Vantagem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("EmpresaParceiraId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SistemaDeMoedaEstudantil.Model.VantagemUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<Guid>("CodigoTroca")
                        .HasColumnType("uniqueidentifier");

                    b.Property<long>("VantagemId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("SistemaDeMoedaEstudantil.Model.Vantagem", b =>
                {
                    b.HasOne("SistemaDeMoedaEstudantil.Model.EmpresaParceira", "EmpresaParceira")
                        .WithMany()
            ...
            modelBuilder.Entity("SistemaDeMoedaEstudantil.Model.VantagemUser", b =>
                {
                    b.HasOne("SistemaDeMoedaEstudantil.Model.Aluno", "Aluno")
                        .WithMany("VantagemUser")
                        .HasForeignKey("AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SistemaDeMoedaEstudantil.Model.Vantagem", "Vantagem")
                        .WithMany("VantagemUser")
