        ...
        <div class="col-12 col-md-4 my-2">
          <div class="position-relative">            
                ...
                <div class="botoesCard">
                  <button type="button" style="display: none" id="btn_editar" onclick="editar(${data[i].id})" data-toggle="modal"
                  ...
                  <button type="button" style="display: none" id="btn_excluir" onclick="deletaModulo(${data[i].id})"
